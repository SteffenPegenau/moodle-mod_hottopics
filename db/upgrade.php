...
function xmldb_hottopics_upgrade($oldversion=0) {
    global $CFG, $DB;
    ...
    /// Define field course to be added to hottopics
        $table = new XMLDBTable('hottopics');
        $field = new XMLDBField('course');
        $field->setAttributes(XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null, null, '0', 'id');
    /// Launch add field course
        $result = $result && $table->add_field($field);

    /// Define field intro to be added to hottopics
    ...
    /// Define field introformat to be added to hottopics
    ...
    /// Define field timecreated to be added to hottopics
        $table = new xmldb_table('hottopics');
    ...
    /// Define index course (not unique) to be added to hottopics
    ...
    /// Add some actions to get them properly displayed in the logs
        $rec = new stdClass;
        $rec->module = 'hottopics';
        $rec->action = 'add';
        $rec->mtable = 'hottopics';
        $rec->filed  = 'name';
